...
class CoreDataTest: XCTestCase {
    ...
    func testCoreData() {
        ...
        coreData?.saveDateToCoreDate(movies: cinemaModel ?? [CinemaModel(posterPath: "", originalTitle: "", overview: "", voteAverage: 0)], context: context)
        ...
        XCTAssert(coreData?.saveDateToCoreDate(movies: cinemaModel ?? [CinemaModel(posterPath: "", originalTitle: "", overview: "", voteAverage: 0)], context: context) == nil)
    }
}
